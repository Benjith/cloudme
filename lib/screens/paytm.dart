...
import 'package:kmjmconnect/model/Gridmodel.dart';
import 'package:kmjmconnect/model/ImageSliderModel.dart';
...
class _PaytmState extends State<Paytm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        // appBar: _appBar(),
        appBar: CustomWidgets.customAppBar(name: 'Dashboard'),
        body: _bodyItem(),
  ...
  List<GridModel> _getGridItemList() {
    ...
    list.add(new GridModel("assets/smartphone.png", "Kerala", null));
    list.add(new GridModel("assets/airplane.png", "Tamilnadu", null));
    list.add(new GridModel("assets/access.png", "Karnataka", null));
    list.add(new GridModel("assets/hand.png", "Andra\nPradesh", null));
    list.add(new GridModel(
        "assets/phone-charge.png", "KSA", null));
    list.add(new GridModel("assets/console.png", "Dubai", null));
